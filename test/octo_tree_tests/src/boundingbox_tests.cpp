...
TEST(BoundingBox, Segment_Bounding)
{
    ...
    EXPECT_TRUE ((seg_bbox.center() == Point{0.0, 0.5, 0.0}) &&
                 Compare::are_equal (seg_bbox.half_width_x (), 0.0) &&
                 Compare::are_equal (seg_bbox.half_width_y (), 0.5) &&
                 Compare::are_equal (seg_bbox.half_width_z (), 0.0));

    Shape<double> seg1 = Segment<double> {Point {0.0, 0.0, 0.0}, Point{1.0, 2.0, 4.0}};
    auto seg1_bbox     = make_bound (seg1, 0);

    EXPECT_TRUE ((seg1_bbox.center() == Point{0.5, 1.0, 2.0}) &&
                 Compare::are_equal (seg1_bbox.half_width_x (), 0.5) &&
                 Compare::are_equal (seg1_bbox.half_width_y (), 1.0) &&
                 Compare::are_equal (seg1_bbox.half_width_z (), 2.0));
}
...
TEST(BoundingBox, Triangle_Bounding)
{
    ...
    EXPECT_TRUE ((tr_xOy_bbox.center() == Point{0.5, 1.0, 0.0}) &&
                 Compare::are_equal (tr_xOy_bbox.half_width_x (), 0.5) &&
                 Compare::are_equal (tr_xOy_bbox.half_width_y (), 1.0) &&
                 Compare::are_equal (tr_xOy_bbox.half_width_z (), 0.0));
    ...
    EXPECT_TRUE ((tr1_bbox.center () == Point {7.5, 11.5, 5.0}) &&
                 Compare::are_equal (tr1_bbox.half_width_x (), 7.5) &&
                 Compare::are_equal (tr1_bbox.half_width_y (), 11.5) &&
                 Compare::are_equal (tr1_bbox.half_width_z (), 5.0));
}
