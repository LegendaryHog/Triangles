...
#define FIXED
    ...
    Triangle tr1 {Point{0.0, 0.0, 0.0},    Point{1.0, 0.0, 0.0},  Point{0.0, 1.0, 0.0}};
    Triangle tr2 {Point{0.51, 0.51, 0.01}, Point{-1.0, 1.0, 0.1}, Point{1.0, -1.0, 0.1}};
